...
const SingleGallary = () => {
    return (
        <div className='card-container w-full sm:w-[320px] h-[500px] overflow-hidden rounded-[20px] border-[8px] border-blue-600 relative'>
            ...
            <div id="card-description" className="card-description w-full h-full top-0 -right-[100%] duration-1000 absolute bg-[#181d4e25] backdrop-blur-sm rounded-2xl p-4 flex flex-col justify-center">
                <h3 className='text-white font-semibold mx-auto text-[24px] md:text-4xl  my-5'>Lego City : Miniature</h3>
                <p className='text-white text-center text-sm md:text-base font-medium'>Construct your very own city with us. A fun way to learn city architecture</p>
